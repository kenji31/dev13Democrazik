...
artisteRepo.save(a7); artisteRepo.save(a8); artisteRepo.save(a9); artisteRepo.save(a10); artisteRepo.save(a11);  artisteRepo.save(a15); artisteRepo.save(a16); artisteRepo.save(a17);
artisteRepo.save(a18); artisteRepo.save(a19);  artisteRepo.save(a21); artisteRepo.save(a22); artisteRepo.save(a23);
...
Morceau m17 = new Morceau("La vie en rose", s1, g10, a9);
Morceau m18 = new Morceau("Les copains d'abord", s1, g10, a11);
Morceau m19 = new Morceau("Ne me quitte pas", s1, g10, a10);
...
Morceau m25 = new Morceau("Can't help falling in love", s2, g6, a5);
Morceau m26 = new Morceau("Love me tender", s2, g6, a5);
Morceau m27 = new Morceau("La vie en rose", s2, g10, a9);
Morceau m28 = new Morceau("Les copains d'abord", s2, g10, a11);
Morceau m29 = new Morceau("Ne me quitte pas", s2, g10, a11);
Morceau m30 = new Morceau("Burning love", s2, g10, a5);
